...
public class NTests {
    ...
    {
        h=new HashN(2);
        assertEquals(5,h.batchInsert(insertbatch("column","colman","colling","cooperate","goal")));
        assertTrue(h.searchForKey(Dictionary.stringToLong("goal")));
        assertEquals(5,h.batchDelete(deletebatch("goal","column","colman","colling","cooperate")));
    }@Test
    public void Test10()
    {
        h=new HashN(2520);
    ...
    public void Test17()
    {
        ...
        assertEquals(2,h.batchDelete(deletebatch("David 98","Mervat 1","Ali 781","Micheil 8")));
        assertFalse(h.searchForKey(Dictionary.stringToLong("David 98"  )));
        assertFalse(h.searchForKey(Dictionary.stringToLong("Mervat 1")));
        assertEquals(3,h.batchInsert(insertbatch("Ali 781","Hoda 30","Mahmod 7","John 44","Oliv 21")));
    }
    @Test
    public void Test18()
    {
