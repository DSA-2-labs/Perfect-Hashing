...
public class NTests {
    ...
    {
        h=new HashN(2);
        assertEquals(5,h.batchInsert(insertbatch("column","colman","colling","cooperate","goal")).success);
        assertTrue(h.searchForKey(Dictionary.stringToLong("goal")));
        assertEquals(5,h.batchDelete(deletebatch("goal","column","colman","colling","cooperate")).success);
    }@Test
    public void Test10()
    {
        h=new HashN(2520);
